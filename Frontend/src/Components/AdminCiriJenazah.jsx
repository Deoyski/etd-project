...
import ModalCiriJenazah from "./Modal/ModalCiriJenazah";
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

function AdminCiriJenazah() {
  ...
  const handleDelete = (id) => {
    fetch(`http://localhost:5000/ciri-jenazah/${id}`, {
      method: "DELETE",
    })
      .then((response) => {
        if (response.ok) {
          ...
          <div className="flex justify-center">
            <div className="w-[90%] flex justify-between items-center">
              <div className="lg:text-5xl text-4xl font-extrabold lg:flex justify-left text-left py-6">
                ...
                <div className="text-[#F3B320] pr-2">Ciri Jenazah</div>
              </div>
              ...
              <div className="py-4 w-full">
                <Table className="overflow-x-auto " striped hoverable>
                  <Table.Head className="text-md">
                    ...
                    <Table.HeadCell className="w-1/12">Kode</Table.HeadCell>
                    ...
                    {dataToRender
                      ...
                      .map((a, index) => (
                        ...
                        >
                          ...
                          <Table.Cell className="py-3 w-8/12 ">
                            {a.keterangan}
                          </Table.Cell>
                          <Table.Cell className="py-3 w-1/12  ">
...
export default AdminCiriJenazah;

          ...
          <div className="flex justify-center">
            <div className="w-[90%] flex justify-between items-center">
              <div className="lg:text-5xl text-4xl font-extrabold lg:flex justify-left text-left py-6">
                ...
                <div className="text-[#F3B320] pr-2">Message</div>
              </div>
              ...
              <div className="py-4 w-full">
                <Table className="overflow-x-auto " striped hoverable>
                  <Table.Head className="text-md">
                    ...
                    <Table.HeadCell className="w-2/12">Name</Table.HeadCell>
                    ...
                    {dataToRender
                      ...
                      .map((a, index) => (
                        ...
                        >
                          ...
                          <Table.Cell className="py-3 w-2/12 whitespace-nowrap">
                            {a.name}
                          </Table.Cell>
                          <Table.Cell className="py-3 w-2/12 whitespace-nowrap">
                            {a.email}
                          ...
                          <Table.Cell className="py-3 w-4/12 whitespace-nowrap">
                            {a.desc}
                          </Table.Cell>
